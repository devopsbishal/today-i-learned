...
| 2026-04-15 | [Helm Advanced Patterns](./2026/april/kubernetes/2026-04-15-helm-advanced-patterns.md) | Subcharts/dependencies + global values + value-scoping, full hook lifecycle (weights, delete policies, hooks-aren't-release-resources gotcha), library charts. OCI registries with ECR specifics, Helmfile orchestration, three-tool testing (helm test/ct/helm-unittest). Decision frameworks for umbrella vs Helmfile vs ArgoCD. |
